"""
Abstract async client interface for Databricks SQL services.

This module defines the abstract interface that all async backend implementations
must follow. It mirrors the DatabricksClient interface but uses async/await.
"""
...
class AsyncDatabricksClient(ABC):
    """
    Abstract async client interface for interacting with Databricks SQL services.

    Implementations of this class are responsible for:
    - Managing async connections to Databricks SQL services
    - Executing SQL queries and commands asynchronously
    - Retrieving query results asynchronously
    ...
    async def open_session(
        ...
        """
        Opens a new session with the Databricks SQL service asynchronously.
    ...
    async def execute_command(
        ...
        """
        Executes a SQL command or query asynchronously within the specified session.
        ...
        (async_op refers to server-side async, not client-side).
        ...
        Args:
            ...
            cursor: The async cursor object that will handle the results
            ...
            async_op: Whether to execute the command asynchronously on the server
            enforce_embedded_schema_correctness: Whether to enforce schema correctness
            row_limit: Maximum number of rows in the response

        Returns:
            If async_op is False, returns an AsyncResultSet object containing the
    ...
    async def cancel_command(self, command_id: CommandId) -> None:
        """
        Cancels a running command or query asynchronously.

        This method attempts to cancel a command that is currently being executed.
        It can be called from a different coroutine than the one executing the command.
    ...
    async def close_command(self, command_id: CommandId) -> None:
        """
        Closes a command and releases associated resources asynchronously.
    ...
    async def get_query_state(self, command_id: CommandId) -> CommandState:
        """
        Gets the current state of a query or command asynchronously.
    ...
    async def get_execution_result(
        ...
        """
        Retrieves the results of a previously executed command asynchronously.
        ...
        Returns:
            AsyncResultSet: An object containing the query results and metadata
    ...
    async def get_catalogs(
        ...
        """
        Retrieves a list of available catalogs asynchronously.
        ...
        Returns:
            AsyncResultSet: An object containing the catalog metadata
    ...
    async def get_schemas(
        ...
        """
        Retrieves a list of schemas asynchronously.
        ...
        Returns:
            AsyncResultSet: An object containing the schema metadata
    ...
    async def get_tables(
        ...
        """
        Retrieves a list of tables asynchronously.
        ...
        Args:
            ...
            table_types: Optional list of table types to filter by

        Returns:
            AsyncResultSet: An object containing the table metadata
    ...
    async def get_columns(
        ...
        """
        Retrieves a list of columns asynchronously.
        ...
        Returns:
            AsyncResultSet: An object containing the column metadata
